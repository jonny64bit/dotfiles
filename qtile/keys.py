...
keys = [
    ...
    Key(
        [mod], "period", lazy.spawn("rofi -modi emoji -show emoji"), desc="Emoji picker"
    ),
    # Volume
    Key(
        [],
        "XF86AudioRaiseVolume",
        lazy.spawn("sh /home/jonny64bit/.config/qtile/volume-up.sh"),
    ),
    Key(
        [],
        "XF86AudioLowerVolume",
        lazy.spawn("sh /home/jonny64bit/.config/qtile/volume-down.sh"),
    ),
    Key(
        [],
        "XF86AudioMute",
        lazy.spawn("sh /home/jonny64bit/.config/qtile/volume-mute-toggle.sh"),
    ),
    # Audio controls
    Key(
        [],
        "XF86AudioNext",
        lazy.spawn("sh /home/jonny64bit/.config/qtile/playerctl.sh next"),
    ),
    Key(
        [],
        "XF86AudioPrev",
        lazy.spawn("sh /home/jonny64bit/.config/qtile/playerctl.sh previuos"),
    ),
    Key(
        [],
        "XF86AudioPlay",
